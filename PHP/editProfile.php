                        ...
                        <div class="col-md-6 noPadding">
                            <form>
                              <div class="form-group">
                                    ...
                                    <input type="text" name="vorname" class="form-control form" placeholder="%Vorname%" value="<?php if(isset($vorname)) { echo $vorname; }else { echo $myUser->getsFirstName();  }?>">
                                    <span class="text-danger"><?php if(isset($vornameError)) echo $vornameError; ?></span>
                              </div>
                              <div class="form-group">
                                    <label for="exampleInputLastname">Nachname</label>
                                    <input type="text" name="nachname" class="form-control form" placeholder="%Nachname%" value="<?php if(isset($nachname)) echo $nachname;  else echo $myUser->getsLastName(); ?>">
                        ...
                        <div class="col-md-6 noPadding">
                            <form>
                              <div class="form-group">
                                    ...
                                    <input type="text" name="username" class="form-control form" placeholder="%UserName%" value="<?php if(isset($username)){ echo $username;} else {echo $myUser->getsUsername();} ?>">
                              ...
                              <div class="form-group">
                                    ...
                                    <input type="email"  name="email" class="form-control form" placeholder="%EMail%"  value="<?php if(isset($email)){ echo $email; } else {$myUser->getsEMail(); }?>">
